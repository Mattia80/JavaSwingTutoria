...
public class FormEvent extends EventObject {
    ...
    public FormEvent(Object source, String marca, String modello, boolean vendita, String targa, String cambio, int bagagliaio, String alimentazione, int numeroPosti) {
        super(source);
        this.marca = marca;
